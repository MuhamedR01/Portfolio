        ...
        <div className="w-1/2 flex items-center justify-center">
          <div className="max-w-md">
            ...
            <div className="flex space-x-4">
              <a href="mailto:info@muhamedrexhepi.tech" className="bg-gray-300 p-3 rounded-full hover:bg-gray-400 transition-colors">
                <EnvelopeSimple size={24} />
              </a>
              <a href="https://www.upwork.com/freelancers/yourusername" target="_blank" rel="noopener noreferrer" className="bg-gray-300 p-3 rounded-full hover:bg-gray-400 transition-colors">
                <UpworkIcon />
              </a>
              <a href="https://www.linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="bg-gray-300 p-3 rounded-full hover:bg-gray-400 transition-colors">
